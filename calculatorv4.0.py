...
def ButtonClick(Number):
    current = myEntry.get()
    myClickClear()
    myEntry.insert(0, str(current) + str(float(Number)))
    myLabel = Label(root, text = "%s %s %s" %(int_num1, operation(math),str(current) + str(float(Number))), padx = 35, pady = 20)
    myLabel.grid(row = 0, column = 0, columnspan = 3)
...
def myClickplus(): 
    ...
    math = "addition"
    global int_num1
    int_num1 = float(number1)
    myClickClear()
    myLabel = Label(root, text = "%s+" %(int_num1), padx = 35, pady = 20)
    myLabel.grid(row = 0, column = 0, columnspan = 3)
...
def myClickequal():
    ...
    if math == "addition":
        myEntry.insert(0, int_num1 + float(number2))
        myLabel = Label(root, text = "%s + %s = %s" %(int_num1, float(number2),int_num1 + float(number2)), padx = 35, pady = 20)
        myLabel.grid(row = 0, column = 0, columnspan = 3)
